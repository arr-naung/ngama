...
-- DropForeignKey
ALTER TABLE "Post" DROP CONSTRAINT "Post_quoteId_fkey";
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_quoteId_fkey" FOREIGN KEY ("quoteId") REFERENCES "Post"("id") ON DELETE CASCADE ON UPDATE CASCADE;
