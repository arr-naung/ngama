...
export default function Compose() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-white dark:bg-black p-4">
            ...
            <ScrollView className="flex-1">
                <View className="flex-row gap-3">
                    ...
                    <View className="flex-1">
                        ...
                        <TextInput
                            className="text-black dark:text-white text-xl mb-4"
                                ...
                                <View className="flex-row items-center gap-2 mb-1">
                                    <View className="h-5 w-5 rounded-full bg-gray-200 dark:bg-gray-800 overflow-hidden">
                                        {referencedPost.author.image ? (
                                            <Image source={{ uri: getImageUrl(referencedPost.author.image)! }} className="w-full h-full" />
                                        ) : (
                                            <View className="w-full h-full items-center justify-center bg-gray-300 dark:bg-gray-700">
            ...
            <View className="absolute bottom-4 left-4 right-4 flex-row border-t border-gray-200 dark:border-gray-800 pt-4 bg-white dark:bg-black">
